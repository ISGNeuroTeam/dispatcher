 ...
 override val dataset: String = """[
  ...
  test("Test 0. Command: rex") {
    ...
    val expected = """[
                     ...
                     |{"_time":1568026476855,"_raw":"{\"serialField\": \"1\", \"random_Field\": \"-90\", \"WordField\": \"rty\", \"junkField\": \"132_.\"}","junkField":"132_."},
  ...
  test("Test 3. Command: rex multival input") {
    ...
    val expected = """[
                     ...
                     |{"_time":1568026476855,"_raw":"{\"serialField\": \"1\", \"random_Field\": \"-90\", \"WordField\": \"rty\", \"junkField\": \"132_.\"}","junkField":"132_.","mvf":["132_.","132_."]},
  ...
  test("Test 4. Command: rex null input") {
    ...
    val expected = """[
                     ...
                     |{"_time":1568026476855,"_raw":"{\"serialField\": \"1\", \"random_Field\": \"-90\", \"WordField\": \"rty\", \"junkField\": \"132_.\"}"},
