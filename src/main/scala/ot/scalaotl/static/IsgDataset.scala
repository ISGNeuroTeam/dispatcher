...
import org.apache.spark.sql.catalyst.analysis.{EliminateEventTimeWatermark, ResolvedStar, UnresolvedAttribute, UnresolvedRegex}
import org.apache.spark.sql.catalyst.catalog.HiveTableRelation
import org.apache.spark.sql.catalyst.encoders.{ExpressionEncoder, RowEncoder, encoderFor}
import org.apache.spark.sql.catalyst.expressions.{Alias, Ascending, Attribute, AttributeReference, CreateStruct, Expression, GetStructField, Literal, NamedExpression, RowOrdering, SortOrder, UserDefinedGenerator}
import org.apache.spark.sql.catalyst.expressions.codegen.GenerateSafeProjection
import org.apache.spark.sql.catalyst.json.{JSONOptions, JacksonGenerator}
import org.apache.spark.sql.catalyst.optimizer.CombineUnions
import org.apache.spark.sql.catalyst.parser.{ParseException, ParserUtils}
import org.apache.spark.sql.catalyst.plans.{Cross, Inner, JoinType, UsingJoin}
import org.apache.spark.sql.catalyst.plans.logical.{AppendColumns, CatalystSerde, Command, Deduplicate, EventTimeWatermark, Except, Filter, Generate, Intersect, Join, Limit, LocalRelation, LogicalPlan, MapElements, MapPartitions, MapPartitionsInR, Project, Repartition, RepartitionByExpression, Sample, Sort, SubqueryAlias, TypedFilter, Union, UnresolvedHint}
...
import org.apache.spark.sql.{AnalysisException, Column, DataFrame, DataFrameNaFunctions, DataFrameStatFunctions, DataFrameWriter, Encoder, Encoders, KeyValueGroupedDataset, RelationalGroupedDataset, Row, SQLContext, SparkSession, TypedColumn, catalyst, functions}
import org.apache.spark.sql.streaming.DataStreamWriter
import org.apache.spark.sql.types.{ArrayType, BinaryType, Metadata, NumericType, StringType, StructType}
